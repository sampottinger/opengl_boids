...
errcheck.o: ./schreuider/errcheck.c
	gcc -g -Wall -c ./schreuider/errcheck.c -o errcheck.o

fatal.o: ./schreuider/fatal.c
	gcc -g -Wall -c ./schreuider/fatal.c -o fatal.o

loadtexbmp.o: ./schreuider/loadtexbmp.c
	gcc -g -Wall -c ./schreuider/loadtexbmp.c -o loadtexbmp.o
